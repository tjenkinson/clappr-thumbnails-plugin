...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,'__esModule',{value:true});var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{'default':obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass,superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _clappr=__webpack_require__(1);var _jquery=__webpack_require__(2);var _jquery2=_interopRequireDefault(_jquery);__webpack_require__(3);var ScrubThumbnailsPlugin=(function(_UICorePlugin){_inherits(ScrubThumbnailsPlugin,_UICorePlugin);_createClass(ScrubThumbnailsPlugin,[{key:'name',get:function get(){return 'scrub-thumbnails';}},{key:'attributes',get:function get(){return {'class':this.name};} /* 
	   ...
	   */}],[{key:'buildSpriteConfig',value:function buildSpriteConfig(spriteSheetUrl,numThumbs,thumbWidth,thumbHeight,numColumns,timeInterval,startTime){startTime = startTime || 0;var thumbs=[];for(var i=0;i < numThumbs;i++) {thumbs.push({url:spriteSheetUrl,time:startTime + i * timeInterval,w:thumbWidth,h:thumbHeight,x:i % numColumns * thumbWidth,y:Math.floor(i / numColumns) * thumbHeight});}return thumbs;}}]);function ScrubThumbnailsPlugin(core){_classCallCheck(this,ScrubThumbnailsPlugin);_get(Object.getPrototypeOf(ScrubThumbnailsPlugin.prototype),'constructor',this).call(this,core);this._loaded = false;this._show = false; // proportion into seek bar that the user is hovered over 0-1
	this._hoverPosition = 0; // each element is {x, y, w, h, imageW, imageH, url, time, duration}
	// one entry for each thumbnail
	this._thumbs = [];this._$backdropCarouselImgs = [];this._init();}_createClass(ScrubThumbnailsPlugin,[{key:'bindEvents',value:function bindEvents(){this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_MOUSEMOVE_SEEKBAR,this._onMouseMove);this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_MOUSELEAVE_SEEKBAR,this._onMouseLeave);this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_RENDERED,this._onMediaControlRendered);}},{key:'_init',value:function _init(){var _this=this; // preload all the thumbnails in the browser
	this._loadThumbnails(function(){ // all thumbnails now preloaded
	_this._loadBackdrop();_this._loaded = true;_this._renderPlugin();});}},{key:'_getOptions',value:function _getOptions(){if(!("scrubThumbnails" in this.core.options)){throw "'scrubThumbnails property missing from options object.";}return this.core.options.scrubThumbnails;}},{key:'_appendElToMediaControl',value:function _appendElToMediaControl(){ // insert after the background
	...
	},{key:'_loadThumbnails',value:function _loadThumbnails(onLoaded){var _this2=this;var thumbs=this._getOptions().thumbs;var cachedImageUrls=[];var thumbsToLoad=thumbs.length;if(thumbsToLoad === 0){onLoaded();return;}var _loop=function(i){var thumb=thumbs[i];_this2._thumbs.push(null);var next=i < thumbs.length - 1?thumbs[i + 1]:null; // the duration this thumb lasts for
	...
	_this2._$imageCache.append($img);cachedImageUrls.push(thumb.url);}var imageW=$img[0].width;var imageH=$img[0].height;_this2._thumbs[i] = {imageW:imageW, // actual width of image
	...
	for(var i=0;i < this._thumbs.length;i++) {var thumb=this._thumbs[i];var $img=this._buildImg(thumb,this._getOptions().backdropHeight);this._$backdropCarousel.append($img);this._$backdropCarouselImgs.push($img);}} // calculate how far along the carousel should currently be slid
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=/home/heberte/terabit/clappr-thumbnails-plugin/node_modules/compass-mixins/lib!./style.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=/home/heberte/terabit/clappr-thumbnails-plugin/node_modules/compass-mixins/lib!./style.scss");
